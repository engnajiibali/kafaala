jQuery(document).ready(function () {
    ...
    var amountInDollar = [[1, 2], [2, 9], [3, 5], [4, 13], [5, 6], [6, 13], [7, 8]];
    var amountInRand = [[1, 0], [2, 6.5], [3, 4], [4, 10], [5, 2], [6, 10], [7, 4]];
    ...
    // Donut Chart: Begining Balance
    var m3 = new Morris.Donut({
        element: 'donut-begining-balance',
        data: [
            { label: "USD", value: 13068 },
            { label: "ZAR", value: 20354 }
        ],
        colors: ['#1CAF9A', '#428BCA']
    });
