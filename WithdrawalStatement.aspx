<%@ Page Title="Withdrawal Statement - Kafaala Cash Management System" Language="C#" MasterPageFile="~/SiteMasterPage.Master" AutoEventWireup="true" CodeBehind="WithdrawalStatement.aspx.cs" Inherits="KafaalaSystem.WithdrawalStatement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMainContent" runat="server">
    ...
    <div class="pageheader">
        <h2><i class="fa fa-money"></i>Withdrawal Statement <span>View Withdrawal Statements</span></h2>
        <div class="breadcrumb-wrapper">
            <span class="label">You are here:</span>
            <ol class="breadcrumb">
                <li><a href="javascript:void(0);">Reports</a></li>
                <li class="active">Withdrawal Statement</li>
            </ol>
        </div>
    </div>
    ...
    <div class="contentpanel">
        <div class="panel panel-primary">
            <div class="panel-heading">
                ...
                <h3 class="panel-title">Withdrawal Statement</h3>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <br />
                                <button type="button" onclick="GetWithdrawalStatementReportData();" class="btn btn-primary btn-sm">Run Report</button>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="reportArea">
                                            <div class="reportHeader">
                                                <div class="center">
                                                    ...
                                                    <div class="titleRow">
                                                        <div class="reportName">Withdrawal Statement</div>
                                                    </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphFooter" runat="server">
    ...
    <script>
        jQuery(document).ready(function () {
            ...
            GetWithdrawalStatementReportData();
        ...
        function GetWithdrawalStatementReportData() {
            ...
            $.ajax({
                type: "POST",
                url: "WithdrawalStatement.aspx/GetWithdrawalStatementReportData",
                    ...
                    try {
                        ...
                        if (dataReturned === null || dataReturned === undefined || dataReturned.length == 0) {
                            ...
                            dataReturned.forEach(function (arrayElem, index) {
                                ...
                                html += '               <td class="dgrid-cell dgrid-cell-padding dgrid-column-0-1 left wrap" role="gridcell">' + HandleCSharpDateWithoutTime(arrayElem.WithDrawalDate) + '</td>';
