<%@ Page Title="Daily Cash Flow - Kafaala Cash Management System" Language="C#" MasterPageFile="~/SiteMasterPage.Master" AutoEventWireup="true" CodeBehind="DailyCashFlow.aspx.cs" Inherits="KafaalaSystem.DailyCashFlow" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMainContent" runat="server">
    ...
    <div class="pageheader">
        <h2><i class="fa fa-calendar"></i>Daily Cash Flow Report</h2>
        <div class="breadcrumb-wrapper">
            <span class="label">You are here:</span>
            <ol class="breadcrumb">
                <li><a href="javascript:void(0);">Reports</a></li>
                <li class="active">Daily Cash Flow Report</li>
            </ol>
        </div>
    </div>
    ...
    <div class="contentpanel">
        <div class="panel panel-primary">
            <div class="panel-heading">
                ...
                <h3 class="panel-title">Daily Cash Flow Report</h3>
            </div>
                                        ...
                                        <div class="reportArea">
                                            <div class="reportHeader">
                                                <div class="center">
                                                    ...
                                                    <div class="titleRow">
                                                        <div class="reportName">Daily Cash Flow Report</div>
                                                    </div>
                                                ...
                                                <div class="dgrid dgrid-grid ui-widget dgrid-03 reportsGrid universal-grid reportsGridCompact" role="grid">
                                                    <div class="dgrid-header dgrid-header-row ui-widget-header" role="row">
                                                        <table class="dgrid-row-table" role="presentation">
                                                            ...
                                                            <tr>
                                                                <th class="dgrid-cell dgrid-cell-padding dgrid-column-0-0 left bold firstColumn " role="columnheader">
                                                                    <div class="dgrid-resize-header-container">
                                                                        <div class="dgrid-resize-handle resizeNode-0-0"></div>
                                                                    </div>
                                                                </th>
                                                                <th class="dgrid-cell dgrid-cell-padding dgrid-column-0-1 parentColumn right bold" role="columnheader" colspan="2">Deposits</th>
                                                                <th class="dgrid-cell dgrid-cell-padding dgrid-column-0-3 parentColumn right bold" role="columnheader" colspan="2">Withdrawals</th>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <div role="row" class=" dgrid-row dgrid-row-even ui-state-default">
                                                                <table class="dgrid-row-table" role="presentation">
                                                                    <tr>
                                                                        ...
                                                                        <td class="dgrid-cell dgrid-cell-padding dgrid-column-0-1-1 right wrap" role="gridcell">2,500.00</td>
                                                                        ...
                                                                        <td class="dgrid-cell dgrid-cell-padding dgrid-column-0-1-4 right wrap" role="gridcell">1,500.00</td>
                                                                    </tr>
                                                                </table>
                                                            </div>
                                                            <div role="row" class=" dgrid-row dgrid-row-odd ui-state-default" id="dgrid_0-row-2">
                                                                <table class="dgrid-row-table" role="presentation">
                                                                    <tr>
                                                                        ...
                                                                        <td class="dgrid-cell dgrid-cell-padding dgrid-column-0-1-1 right wrap" role="gridcell"></td>
                                                                        <td class="dgrid-cell dgrid-cell-padding dgrid-column-0-1-2 right wrap" role="gridcell">3,000.00</td>
                                                                        <td class="dgrid-cell dgrid-cell-padding dgrid-column-0-1-3 right wrap" role="gridcell"></td>
                                                            ...
                                                            <div role="row" class=" dgrid-row dgrid-row-even ui-state-default" id="dgrid_0-row-3">
                                                                <table class="dgrid-row-table" role="presentation">
                                                                    <tr>
                                                                        ...
                                                                        <td class="dgrid-cell dgrid-cell-padding dgrid-column-0-1-1 right wrap" role="gridcell">150.00</td>
                                                                        <td class="dgrid-cell dgrid-cell-padding dgrid-column-0-1-2 right wrap" role="gridcell">3,700.00</td>
                                                                        <td class="dgrid-cell dgrid-cell-padding dgrid-column-0-1-3 right wrap" role="gridcell"></td>
                                                                        <td class="dgrid-cell dgrid-cell-padding dgrid-column-0-1-4 right wrap" role="gridcell"></td>
                                                                    </tr>
                                                                </table>
                                                            ...
                                                            <div role="row" class=" dgrid-row dgrid-row-odd ui-state-default" id="dgrid_0-row-4">
                                                                <table class="dgrid-row-table" role="presentation">
                                                                    <tr>
                                                                        ...
                                                                        <td class="dgrid-cell dgrid-cell-padding dgrid-column-0-1-1 right wrap" role="gridcell">200.00</td>
                                                                        <td class="dgrid-cell dgrid-cell-padding dgrid-column-0-1-2 right wrap" role="gridcell"></td>
                                                                        <td class="dgrid-cell dgrid-cell-padding dgrid-column-0-1-3 right wrap" role="gridcell">240.00</td>
                                                                        <td class="dgrid-cell dgrid-cell-padding dgrid-column-0-1-4 right wrap" role="gridcell"></td>
                                                                    </tr>
                                                                </table>
                                                            </div>
                                                                ...
                                                                <table class="dgrid-row-table" role="presentation">
                                                                    <tr>
                                                                        <td class="dgrid-cell dgrid-cell-padding dgrid-column-0-0 black left  grandTotalRow topSummary" role="gridcell">
                                                                            <div class="dgrid-expando-icon hide">&nbsp;</div>
                                                                            TOTAL</td>
                                                                        <td class="dgrid-cell dgrid-cell-padding dgrid-column-0-1-1 black right wrap grandTotalRow topSummary bold" role="gridcell">$2,850.00</td>
                                                                        <td class="dgrid-cell dgrid-cell-padding dgrid-column-0-1-2 black right wrap grandTotalRow topSummary bold" role="gridcell">R6,700.00</td>
                                                                        <td class="dgrid-cell dgrid-cell-padding dgrid-column-0-1-3 black right wrap grandTotalRow topSummary bold" role="gridcell">$240.00</td>
                                                                        <td class="dgrid-cell dgrid-cell-padding dgrid-column-0-1-4 black right wrap grandTotalRow topSummary bold" role="gridcell">R1,500.00</td>
                                                                    </tr>
                                                                </table>
                                                            </div>
                                                        </div>
